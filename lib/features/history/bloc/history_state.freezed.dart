...
mixin _$HistoryState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<AssessmentHistory> items) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<AssessmentHistory> items)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<AssessmentHistory> items});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<AssessmentHistory> items) : _items = items;

  final List<AssessmentHistory> _items;
  @override
  List<AssessmentHistory> get items {
...
abstract class _Loaded implements HistoryState {
  const factory _Loaded(final List<AssessmentHistory> items) = _$LoadedImpl;
