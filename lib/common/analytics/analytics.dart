...
class Analytics {
  ...
  void intakeAnswer(String qid, String answer, bool isUnknown) =>
      log('intake_answer', {'qid': qid, 'answer': answer, 'is_unknown': isUnknown});
  void intakeComplete(int count, int durationMs, bool hasUnknown, String status) => log('intake_complete', {
  ...
  void nextStepClick(String action) => log('next_step_click', {'action': action});
}
